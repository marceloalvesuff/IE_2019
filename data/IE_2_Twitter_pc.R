...
token <- create_token(
  app = "twittermarcelo",
  consumer_key = "uR7uOcGBzLYLU10paABEiJHgC",
  consumer_secret = "ENA0LG3xkyObLOaOgCDONCoog8KqE17dclFjyEyhUuvNGO7pMD",
  access_token = "204837436-4evt3CZgWdNnRt8XBKnLKy0rs7MrWvVwIdw15BuT", 
  access_secret = "2ZaMlZeaI1i8gPnwlbTvzuUimlXdLAwclzkDMXa3ss23J")
